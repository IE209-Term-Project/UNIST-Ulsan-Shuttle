...
DEMO = [
    ('금오후', 'to_station', '13:56', '2026-06-05', 9),   # 고정편, 양호
    ('금저녁', 'to_station', '17:52', '2026-06-05', 6),   # 고정편
    ('목오후', 'to_station', '13:56', '2026-06-04', 7),   # ★ 조건부 7명(N*=8) → 발표 때 1명 추가하면 확정 라이브
    ('토오후', 'to_station', '13:56', '2026-06-06', 3),   # 조건부 미달 → 카풀 시연
    ('일저녁', 'to_campus', '18:38', '2026-06-07', 12),   # 고정편(복귀)
]
