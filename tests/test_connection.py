...
def test_to_station_safe():
    ...
    r = evaluate_connection('to_station', bus_arrival_min=2, train_time='13:58',
...
def test_to_station_miss():
    ...
    r = evaluate_connection('to_station', bus_arrival_min=50, train_time='13:58', now=NOW)
...
def test_to_campus_good():
    r = evaluate_connection('to_campus', bus_arrival_min=8, train_time='13:00', now=NOW)
