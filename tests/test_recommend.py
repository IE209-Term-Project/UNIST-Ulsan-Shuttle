...
def test_conditional_below_threshold_books_and_pending():
    s = MemoryReservationStore()
    for i in range(6):
        s.add(f'U{i}', 'to_station', '14:10', '2026-06-04')  # 목 조건부, 6명
    r = recommend(s, '신규', 'to_station', '14:10', '2026-06-04')
...
def test_conditional_reaching_threshold_confirms():
    s = MemoryReservationStore()
    for i in range(7):
        s.add(f'U{i}', 'to_station', '14:10', '2026-06-04')  # 7명
    r = recommend(s, '8번째', 'to_station', '14:10', '2026-06-04')
